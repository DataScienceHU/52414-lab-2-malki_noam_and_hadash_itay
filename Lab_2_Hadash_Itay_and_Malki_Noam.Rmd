...
Ower assmptions of the model is that countries with the most players with Overall<br> abilities that over 80 can be seen in the top 50 football national teams.<br>
...
```
 ...
 The model that managed to predict only 43% of the log of average total fifa<br> score of a state variance.
 ...
 fitting a model with R squared of 43% is not a the worst model.<br>
