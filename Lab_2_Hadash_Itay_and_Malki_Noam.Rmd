...
**a)**
```{r}
fifa_players %>% ggplot(aes(Age)) + geom_histogram(color = "black", fill = "blue", bins = 33) +
  coord_cartesian(ylim = c(0,1500)) 
```

**b)**
```{r}
fifa_players %>% ggplot(aes(x = League, y = Overall)) + geom_boxplot() + theme(axis.text = element_text(size = 7),
