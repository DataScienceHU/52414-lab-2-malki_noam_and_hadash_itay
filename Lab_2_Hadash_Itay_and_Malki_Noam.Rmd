...
mapCountryData(jj,"Freq",mapTitle = "NUMBER OF PLAYERS",lwd = 1.3,catMethod=c(seq(0,2100,20)))
...
map_over<-rbind(map_over,uk)
map_over<-as.data.frame(map_over)
colnames(map_over)[1] <- "Country"
map_over$Overall_avg<-as.numeric(map_over$Overall_avg)
jj2<-joinCountryData2Map(map_over,nameJoinColumn = "Country","NAME")
mapCountryData(jj2,nameColumnToPlot = "Overall_avg",catMethod=c(seq(0,120,5)))
